...
class Vehicle(object):
    ...
    def vehicle_find(self, frame):
        ...
        bboxes = []
        for scale_val in self.scale:
            boxes_list = find_cars(frame, ystart=self.ystart, ystop=self.ystop, scale=scale_val,
                        svc=svc, X_scaler=X_scaler, orient=9, pix_per_cell=8,
                        cell_per_block=2, spatial_size=spatial_size, hist_bins=32)
        ...
        heat = apply_threshold(self.ave_heat, 2)
